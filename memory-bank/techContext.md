...
4. `./gradlew test` для запуска тестов (98+ юнит-тестов)
...
- Таблицы: users, roles, user_roles, clubs, teams, team_coaches, inventory, exercises, exercise_inventory

## Technical Constraints
- `spring.servlet.multipart.max-file-size=200KB` — нужно увеличить до 500KB для картинок упражнений
